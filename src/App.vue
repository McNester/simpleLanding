...
export default{
  ...
  data() {
    return {
      peopleForCard:[
        {id:0,name:'Lara Lin',srcImg:'/imgSrcfirstPerson.png',comment:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae, in tristique senectus dui pharetra sit.'},
